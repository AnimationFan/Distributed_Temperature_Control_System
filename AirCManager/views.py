...
def get_states(request):
    if controller.on!=False:
        ...
        for airc_info in airc_info_list:
            ...
            if airc_info["Wind"] == 3:
                airc_info["Wind"] = "高"
    modle=config_info.DefaultModle
    default_temp=config_info.DefaultTemp
    producer_num=config_info.ProducerNum
    price=config_info.Price
    states={"airc_states":airc_info_list,"modle":modle,"default_temp":default_temp,"producer_num":producer_num,"price":price}
